...
class PlayerService {
  ...
  private getComprehensivePlayerDatabase(): Player[] {
    return [
      // NFL Players (expanded list with 2024 current players)
      ...
      { id: 1010, name: "Russell Wilson", team: "Pittsburgh Steelers", sport: "NFL", position: "QB" },
      { id: 1011, name: "Kyler Murray", team: "Arizona Cardinals", sport: "NFL", position: "QB" },
      { id: 1012, name: "Kirk Cousins", team: "Atlanta Falcons", sport: "NFL", position: "QB" },
      { id: 1013, name: "Daniel Jones", team: "New York Giants", sport: "NFL", position: "QB" },
      { id: 1014, name: "Caleb Williams", team: "Chicago Bears", sport: "NFL", position: "QB" },
      { id: 1015, name: "C.J. Stroud", team: "Houston Texans", sport: "NFL", position: "QB" },
      { id: 1016, name: "Anthony Richardson", team: "Indianapolis Colts", sport: "NFL", position: "QB" },
      
      // Running Backs
      { id: 1020, name: "Christian McCaffrey", team: "San Francisco 49ers", sport: "NFL", position: "RB" },
      { id: 1021, name: "Derrick Henry", team: "Baltimore Ravens", sport: "NFL", position: "RB" },
      { id: 1022, name: "Nick Chubb", team: "Cleveland Browns", sport: "NFL", position: "RB" },
      { id: 1023, name: "Josh Jacobs", team: "Green Bay Packers", sport: "NFL", position: "RB" },
      { id: 1024, name: "Saquon Barkley", team: "Philadelphia Eagles", sport: "NFL", position: "RB" },
      { id: 1025, name: "Austin Ekeler", team: "Washington Commanders", sport: "NFL", position: "RB" },
      { id: 1026, name: "Alvin Kamara", team: "New Orleans Saints", sport: "NFL", position: "RB" },
      { id: 1027, name: "Tony Pollard", team: "Tennessee Titans", sport: "NFL", position: "RB" },
      { id: 1028, name: "D'Andre Swift", team: "Chicago Bears", sport: "NFL", position: "RB" },
      { id: 1029, name: "Isiah Pacheco", team: "Kansas City Chiefs", sport: "NFL", position: "RB" },
      { id: 1030, name: "Breece Hall", team: "New York Jets", sport: "NFL", position: "RB" },
      { id: 1031, name: "Bijan Robinson", team: "Atlanta Falcons", sport: "NFL", position: "RB" },
      { id: 1032, name: "Kenneth Walker III", team: "Seattle Seahawks", sport: "NFL", position: "RB" },
      { id: 1033, name: "Jahmyr Gibbs", team: "Detroit Lions", sport: "NFL", position: "RB" },
      { id: 1034, name: "Jonathan Taylor", team: "Indianapolis Colts", sport: "NFL", position: "RB" },
      
      // Wide Receivers
      { id: 1040, name: "Tyreek Hill", team: "Miami Dolphins", sport: "NFL", position: "WR" },
      { id: 1041, name: "Davante Adams", team: "Las Vegas Raiders", sport: "NFL", position: "WR" },
      { id: 1042, name: "Cooper Kupp", team: "Los Angeles Rams", sport: "NFL", position: "WR" },
      { id: 1043, name: "Stefon Diggs", team: "Houston Texans", sport: "NFL", position: "WR" },
      { id: 1044, name: "DeAndre Hopkins", team: "Tennessee Titans", sport: "NFL", position: "WR" },
      { id: 1045, name: "Mike Evans", team: "Tampa Bay Buccaneers", sport: "NFL", position: "WR" },
      { id: 1046, name: "A.J. Brown", team: "Philadelphia Eagles", sport: "NFL", position: "WR" },
      { id: 1047, name: "DK Metcalf", team: "Seattle Seahawks", sport: "NFL", position: "WR" },
      { id: 1048, name: "Calvin Ridley", team: "Tennessee Titans", sport: "NFL", position: "WR" },
      { id: 1049, name: "Ja'Marr Chase", team: "Cincinnati Bengals", sport: "NFL", position: "WR" },
      { id: 1050, name: "Justin Jefferson", team: "Minnesota Vikings", sport: "NFL", position: "WR" },
      { id: 1051, name: "CeeDee Lamb", team: "Dallas Cowboys", sport: "NFL", position: "WR" },
      { id: 1052, name: "Amon-Ra St. Brown", team: "Detroit Lions", sport: "NFL", position: "WR" },
      { id: 1053, name: "Puka Nacua", team: "Los Angeles Rams", sport: "NFL", position: "WR" },
      { id: 1054, name: "Chris Olave", team: "New Orleans Saints", sport: "NFL", position: "WR" },
      { id: 1055, name: "Garrett Wilson", team: "New York Jets", sport: "NFL", position: "WR" },
      { id: 1056, name: "Nico Collins", team: "Houston Texans", sport: "NFL", position: "WR" },
      { id: 1057, name: "D.J. Moore", team: "Chicago Bears", sport: "NFL", position: "WR" },
      { id: 1058, name: "Jaylen Waddle", team: "Miami Dolphins", sport: "NFL", position: "WR" },
      { id: 1059, name: "Terry McLaurin", team: "Washington Commanders", sport: "NFL", position: "WR" },
      { id: 1060, name: "Drake London", team: "Atlanta Falcons", sport: "NFL", position: "WR" },
      { id: 1061, name: "Tee Higgins", team: "Cincinnati Bengals", sport: "NFL", position: "WR" },
      { id: 1062, name: "Marvin Harrison Jr.", team: "Arizona Cardinals", sport: "NFL", position: "WR" },
      { id: 1063, name: "Rome Odunze", team: "Chicago Bears", sport: "NFL", position: "WR" },
      { id: 1064, name: "Malik Nabers", team: "New York Giants", sport: "NFL", position: "WR" },
      
      // Tight Ends
      { id: 1070, name: "Travis Kelce", team: "Kansas City Chiefs", sport: "NFL", position: "TE" },
      { id: 1071, name: "Mark Andrews", team: "Baltimore Ravens", sport: "NFL", position: "TE" },
      { id: 1072, name: "George Kittle", team: "San Francisco 49ers", sport: "NFL", position: "TE" },
      { id: 1073, name: "Kyle Pitts", team: "Atlanta Falcons", sport: "NFL", position: "TE" },
      { id: 1074, name: "T.J. Hockenson", team: "Minnesota Vikings", sport: "NFL", position: "TE" },
      { id: 1075, name: "Dallas Goedert", team: "Philadelphia Eagles", sport: "NFL", position: "TE" },
      { id: 1076, name: "Sam LaPorta", team: "Detroit Lions", sport: "NFL", position: "TE" },
      { id: 1077, name: "Evan Engram", team: "Jacksonville Jaguars", sport: "NFL", position: "TE" },
      { id: 1078, name: "David Njoku", team: "Cleveland Browns", sport: "NFL", position: "TE" },
      { id: 1079, name: "Jake Ferguson", team: "Dallas Cowboys", sport: "NFL", position: "TE" },
